                ...
                <div class="login-content">
                    ...
                    <form  class="sign-form widget-form" action="{{ route('guest.register') }}" method="post">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="/auth/google/redirect" class="mb-3" style="border: 1px solid #000; padding: 15px 25px;"> Login with GOOGLE</a>
                            <a href="/auth/github/redirect" class="mb-3" style="border: 1px solid #000; padding: 15px 25px;"> Login with GITHUB</a>
                        </div>
